...
Niagara authoring depth plus engine source search. Adds module input + static switch writes, a custom-HLSL module factory, and a batched-op dispatcher for the Niagara stack; extends engine-source discovery with a full Runtime/Editor/Developer/Plugins grep.
